...
class Arene:
    ...
    def afficher_personnages(self) -> list[str]:
        """
    ...
    def organiser_combat(self, lst_combattants: list[Personnage, Personnage]) -> list[str]:
        """
        ...
        # Créer des copies des personnages pour ne pas modifier les originaux et définir les rôles initials
        perso_attaquant = deepcopy(lst_combattants[0])
        perso_defenseur = deepcopy(lst_combattants[1])
